...
class RegistrationHandler(BaseHandler):
    ...
    @defer.inlineCallbacks
    def get_isapproved(self,user_id):
        is_user_approved_data = yield self.store.get_all_isapproved(user_id)
        defer.returnValue(is_user_approved_data)

    @defer.inlineCallbacks
    def get_banDate(self,user_id):
        ban_date = yield self.store.get_ban_date(user_id)
        defer.returnValue(ban_date)
