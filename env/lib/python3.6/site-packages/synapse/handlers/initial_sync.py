...
class InitialSyncHandler(BaseHandler):
    ...
    def get_all_rooms_handle(self):
         room_list = self.store.get_all_rooms()
    ...
    def get_all_members_handle(self):
        
         room_members_list= self.store.get_all_members()
         print('yesss')
        
         print(room_members_list)
         return room_members_list
    
    def get_all_not_approved_handle(self):
        not_approved_list = self.store.get_all_notapproved()
        print("not_approved list")
        print(not_approved_list)
        return not_approved_list
    
    def get_all_users_handle(self):
        users_list = self.store.get_all_users()
        print("users_list")
        print(users_list)
        return users_list
    def add_ban_period(self,user_id,user_para):
        self.store.add_ban_period1(user_id,user_para)
        result = [{'admin':0,}]
        return result        
    def change_isapproved_handle(self,user_id):
        print("devil 2.0")
        print(user_id)
        self.store.change_isapproved(user_id)
        print("devil")
        result = [{'admin':0,}]
        return result

    def change_isapproved_handle_abc(self,user_id):
        print("devil 3.0")
        print(user_id)
        self.store.change_isapproved_abc(user_id)
        print("devil3")
        result = [{'admin':0,}]
        return result
